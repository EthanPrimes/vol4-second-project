...
\begin{align*}
    ...
    \text{and } \| \mathbf{u} \| &= v,
\end{align*}
where $\phi(x, y)$ gives the $x$ and $y$ components of the velocity of the wind. So, the Hamiltonian is given by 
...
So the costate evolution equations, and Pontryagin's Maximum Principle, will yeild
...
\subsection{Model 2: Square-Sail Dynamics}
\par The solution here is almost identical to the previous problem, just with the $\cos(\theta - \phi)$ terms accounted for. We were able to solve it similarly using \verb|scipy.solve_bvp()|.
