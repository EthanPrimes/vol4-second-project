...
\par We implemented this formulation as a boundary value problem using \texttt{scipy.solve\_bvp()}. However, since the optimal solution discontinually switches between headings while going upwind or downwind, the solution has sharp corners which break \texttt{scipy.solve\_bvp()}, which expects smooth solutions.
