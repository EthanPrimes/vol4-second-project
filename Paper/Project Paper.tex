...
\par This new dynamic can be neatly added to our model of Zermelo Navigation (Model 1) by making velocity a function of the wind direction and the boat's heading. We created a velocity function that matches sailing speeds respecting wind direction and boat heading.
...
\par Where $\phi(x, y)$ gives the $x$ and $y$ components of the velocity of the wind.
