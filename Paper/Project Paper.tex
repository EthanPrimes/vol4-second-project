...
\subsection{Model 4: Acceleration and Land Penalties}
\par We will again work out the details of Patryagin's Maximum principle before discussing our implementation. With the $\dot{x} = f$ relation as described in Section~\ref{sec:model4}, the Hamiltonian is given by 
