...
\large We have a lot of further directions we want to explore. The first things that we want to incorporate into our models are land penalties, to prevent the boats from running into land or islands. This is the most obvious issue with the optimal solutions we have computed so far. \cite{einstein1905}
